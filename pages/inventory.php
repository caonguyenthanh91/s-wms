<div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <section>
        <div class="bg-white p-6 rounded-lg shadow-md mb-6">
            <h3 class="text-lg font-bold mb-4 text-gray-800 flex items-center">
                <span class="mr-2">🔍</span> Tìm theo Mã Sản Phẩm (SKU)
            </h3>
            <div class="flex gap-2">
                <div class="relative flex-1">
                    <input type="text" id="search-product-id" placeholder="VD: SKU001..."
                           class="w-full px-4 py-2 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none uppercase font-mono text-sm">
                ...
                <button onclick="searchByProduct()" class="bg-blue-600 text-white px-4 py-2 rounded-lg font-bold hover:bg-blue-700 transition text-sm">
                    Tìm
                </button>
            </div>
        </div>
        ...
        <div id="product-results-container" class="bg-white rounded-lg shadow-md overflow-hidden hidden">
            <div class="p-4 border-b bg-blue-50">
                <h4 class="font-bold text-blue-800">SKU: <span id="res-sku" class="font-mono"></span></h4>
    ...
    <section>
        <div class="bg-white p-6 rounded-lg shadow-md mb-6">
            <h3 class="text-lg font-bold mb-4 text-gray-800 flex items-center">
                <span class="mr-2">📍</span> Tìm theo Mã Vị Trí (Shelf ID)
            </h3>
            <p class="text-xs text-gray-500 mb-3">Co the nhap ma ke (VD: A-01-01) hoac ma kho tam dang TEMP-&lt;PALLET_ID&gt;.</p>
            <div class="flex gap-2">
                <div class="relative flex-1">
                    <input type="text" id="search-shelf-id" placeholder="VD: A-01-01..."
                           class="w-full px-4 py-2 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 outline-none uppercase font-mono text-sm">
        ...
        <div id="shelf-results-container" class="bg-white rounded-lg shadow-md overflow-hidden hidden">
            <div class="p-4 border-b bg-green-50">
                <h4 class="font-bold text-green-800">Kệ: <span id="res-shelf" class="font-mono"></span></h4>
            </div>
            <table class="w-full text-left border-collapse text-sm">
                <thead>
                    <tr class="bg-gray-100 text-gray-600 uppercase text-[10px] font-bold">
...
function searchByProduct() {
    const pid = $('#search-product-id').val().trim();
    if (!pid) return;
